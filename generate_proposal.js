    ...
    sections: [
        ...
        // ==================== BAB II ====================
        {
            ...
            children: [
                ...
                mixedBody([
                    {text: "Teori Portofolio Modern (MPT), yang dipelopori oleh Harry Markowitz (1952), merupakan landasan utama dalam manajemen investasi yang memperkenalkan kerangka optimasi "},
                    {text: "mean-variance", italic: true},
                    {text: ". Prinsip dasar MPT menyatakan bahwa investor yang rasional akan berusaha memaksimalkan imbal hasil yang diharapkan ("},
                    {text: "expected return", italic: true},
                    {text: ") untuk tingkat risiko tertentu melalui pembentukan portofolio yang efisien pada "},
                    {text: "Efficient Frontier", italic: true},
                    {text: " [mendeley_cite:markowitz1952portfolio]. Inti dari teori ini terletak pada manfaat diversifikasi, di mana risiko total portofolio tidak hanya ditentukan oleh variansi aset individual, tetapi juga oleh kovarians atau derajat pergerakan bersama antar aset tersebut."}
                ]),
                emptyLine(),
                mixedBody([
                    {text: "Namun, dalam implementasi praktisnya, MPT menghadapi tantangan besar yang dikenal sebagai "},
                    {text: "Markowitz Curse", italic: true},
                    {text: " atau enigma optimasi Markowitz [mendeley_cite:michaud1989markowitz]. Masalah ini muncul karena algoritma optimasi sangat sensitif terhadap parameter input (estimasi imbal hasil dan matriks kovarians). Karena parameter tersebut sering kali diestimasi dari data historis yang mengandung "},
                    {text: "noise", italic: true},
                    {text: ", algoritma cenderung memberikan bobot ekstrem pada aset dengan estimasi imbal hasil tinggi atau risiko rendah secara semu. Hal ini mengakibatkan kesalahan estimasi kecil pada data input diperkuat secara signifikan ("},
                    {text: "error maximization", italic: true},
                    {text: "), menghasilkan alokasi bobot yang sangat tidak stabil dan sering kali memiliki performa "},
                    {text: "out-of-sample", italic: true},
                    {text: " yang buruk. Keterbatasan inilah yang memicu perlunya pendekatan alternatif seperti analisis jaringan finansial untuk meningkatkan ketangguhan ("},
                    {text: "robustness", italic: true},
                    {text: ") model."}
                ]),
                emptyLine(),
